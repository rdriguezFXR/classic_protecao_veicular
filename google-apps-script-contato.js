...
// ==================== CONFIGURAÇÕES ====================
const CONFIG = {
  // ID da planilha (da URL: docs.google.com/spreadsheets/d/[ESTE_ID]/edit)
  SPREADSHEET_ID: '1gamY7_0k-thks_oTjgCM4n1eq7TnuFn5C-MIBarFgg8',
...
function enviarEmailConfirmacaoUsuario(dados) {
  try {
    ...
    // Não lança erro para não bloquear o processo
  }
}
